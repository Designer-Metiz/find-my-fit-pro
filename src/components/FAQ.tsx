...
const FAQ = () => {
  return (
    <section id="faq" className="mt-5 py-16 px-5 bg-gradient-to-br from-slate-50 via-white to-primary/10">
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 max-w-5xl">
          <Accordion
            ...
            collapsible
            defaultValue="item-0"
            className="grid w-full grid-cols-1 md:grid-cols-2 gap-5"
          >
            {faqs.map((faq, index) => (
              <AccordionItem
                key={index}
